      ...
      <div class="card-body">
        ...
        <div class="mb-3">
          ...
          <template v-if="currentMode === 'edit' && mainView">
            <input v-model="localTask.title" class="form-control" placeholder="Enter a task title" required />
          </template>
          <template v-else>
        ...
        <div class="mb-3">
          ...
          <template v-if="currentMode === 'edit' && mainView">
            <input v-model="localTask.label" class="form-control" placeholder="Enter a label" required />
          </template>
          <template v-else>
    ...
    <div class="card mb-4">
      ...
      <div class="card-body">
        <div class="mb-3">
          ...
          <template v-if="currentMode === 'edit' && mainView">
            <input type="date" v-model="localTask.start_date" class="form-control" />
          </template>
          <template v-else>
        ...
        <div class="mb-3">
          ...
          <template v-if="currentMode === 'edit' && mainView">
            <input type="date" v-model="localTask.end_date" class="form-control" />
          </template>
          <template v-else>
...
export default {
  ...
  methods: {
    ...
    fileIcon(type) {
      switch (type) {
        case 'docx': return 'bi bi-file-word text-primary';
        case 'pptx': return 'bi bi-filetype-ppt text-danger';
        case 'xlsx': return 'bi bi-file-earmark-excel text-success';
        case 'pdf': return 'bi bi-file-pdf text-danger';
        case 'jpg': return 'bi bi-file-image text-warning';
