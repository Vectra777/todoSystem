...
('t1', 'Development', 'Web Development Team', 1),
('t2', 'Design', 'UX/UI Design Team', 1),
('t3', 'Marketing', 'Digital Marketing Team', 1);
...
INSERT INTO competences (id, title, description, start_date, end_date, label, company_id) VALUES
(
    1,
    'Express',
